...
export function RegisterForm({ className, ...props }: React.ComponentProps<"form">) {
  ...
  const handleSSO = (provider: string) => {
    handleSSOLogin(provider, navigate);
  }
      ...
      >
        ...
        <div className="grid gap-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <Button variant="outline" type="button" className="w-full" onClick={() => handleSSO('google')}>
              ...
              <span className="sr-only">{t("register.google")}</span>
            </Button>
            <Button variant="outline" type="button" className="w-full" onClick={() => handleSSO('github')}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                <path
              ...
              <span className="sr-only">{t("register.github")}</span>
            </Button>
          </div>
        </div>
